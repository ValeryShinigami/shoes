...
class ProduitController extends Controller
{
    ...
    public function index()
    {
        //
          ...
          return view('user.produits.index', compact('produits', 'marques'));
    }
    ...
    public function create(Request $request)
    {
        ...
        //return view ('user.produits.create', compact('produit'));
        //dd($produit);
        $marques = marque::where('isOnline', 1)->get();
        return view ('user.produits.create', compact('produit','marques')); //on récupère les produit par id de la BDD
